# Angular Boot Camp example: deferrable-views
...
**[StackBlitz for deferrable-views](https://stackblitz.io/github/AngularBootCamp/deferrable-views)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/deferrable-views.git
cd deferrable-views
npm install
npm start
```
